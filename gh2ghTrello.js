...
//  * Version: 10.0 (Dual Push: GitHub + Trello)
//  *********************************/
...
// const TRELLO_CARD_ID          = "CIIouy8k"; // 您原本代碼中的 Card ID
...
//   // ----------------------------------------------------
//   // 4. Push to External Services (Dual Push)
//   // ----------------------------------------------------
  
//   // (A) GitHub Issues - 主要紀錄
//   sendToGitHub(finalText);

//   // (B) Trello - 備份/看板 (若要取消，請將下一行註解掉)
//   sendToTrello(finalText);
// }

// // ==========================================
// // ====    SENDER FUNCTIONS (Separated)  ====
// // ==========================================
...
//   Logger.log(">>> Starting GitHub Push...");
...
//       Logger.log('✅ GitHub 成功！連結: ' + responseBody.html_url);
//     } else {
//       Logger.log('❌ GitHub 失敗。代碼: ' + responseCode + ' | 訊息: ' + response.getContentText());
//     }
//   } catch (e) {
//     Logger.log('❌ GitHub 例外錯誤: ' + e.toString());
//   }
// }
